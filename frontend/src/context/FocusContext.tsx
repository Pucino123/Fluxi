...
export function FocusProvider({ children }: { children: ReactNode }) {
  ...
  const value: FocusContextValue = {
    ...
    desktopFolderLabelGaps: state.desktopFolderLabelGaps ?? {},
    updateDesktopFolderLabelGap: (folderId, gap) =>
      setState((prev) => ({ ...prev, desktopFolderLabelGaps: { ...(prev.desktopFolderLabelGaps ?? {}), [folderId]: gap } })),
