...
import { Timer, Music, CalendarClock, StickyNote, Clock, BarChart3, FileText, MessageSquareQuote, Wind, Users, DollarSign, PieChart, Dumbbell, ListTodo, Briefcase, Sparkles, Award, Brain, X, ChevronUp, Focus, Hammer, MessageCircle, Lightbulb, RotateCcw, Repeat, UserCircle2 } from "lucide-react";
...
const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "council-member", label: "Advisor", icon: UserCircle2 },
