    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className={`relative flex flex-col backdrop-blur-2xl border rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 z-10 ${
