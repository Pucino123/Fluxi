...
const CollabMessagesModal = ({ open, onOpenChange }: CollabMessagesModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-black/80 backdrop-blur-[24px] border-white/15 text-white max-w-md p-0 gap-0 rounded-2xl overflow-hidden [&>button[class*='absolute']]:hidden">
